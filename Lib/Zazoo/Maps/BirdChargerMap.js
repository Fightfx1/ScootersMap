...
function BirdChargerMap(app)
{
    app.get('/Map/BirdCharger', function(req, res){
        if(req.query.longitude != undefined && req.query.ChatId != undefined && req.query.latitude != undefined) // Chack That theren't miss parameter.
        {
            ...
            Bird.GetBirdForChargeAlerts(latitude,longitude).then(function(response){
                if(response != false)
                {
                    ...
                    let zoomLevel = 18 // Zoom Of The Map
...
module.exports.BirdChargerMap = BirdChargerMap;